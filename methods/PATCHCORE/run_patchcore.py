...
if __name__ == "__main__":
    ...
    results_dir = os.path.join(project_root, "methods", "PATCHCORE", "results")
    os.makedirs(results_dir, exist_ok=True)

    # -----------------------
    # 🧩 DATA MODULE
    # -----------------------
    category = "bottle"  # 👉 змінюй на carpet, cable, hazelnut тощо
    datamodule = MVTec(
        root=dataset_root,
        category=category,
        image_size=(256, 256),
    ...
    engine = Engine(
        ...
        devices=1,
        logger=False,
        default_root_dir=results_dir,  # ✅ усе в methods/PATCHCORE/results
    )
